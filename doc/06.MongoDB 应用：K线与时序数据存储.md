...
| :--------------------------------------- | :------------------------------------- |
| `exchange_turnover_statistics` (MongoDB) | 币币交易成交额的日统计数据。           |
| `member_log` (MongoDB)                   | 每日用户数据统计，如注册数、实名数等。 |
| `turnover_statistics` (MongoDB)          | 平台总交易额的日统计数据。             |
| exchange_kline_*                         | k线数据                                |
| eth_address_book                         | web3钱包账号                           |
